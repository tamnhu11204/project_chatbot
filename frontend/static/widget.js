(function () {
    ...
    function initChatbot() {
        ...
        toggleBtn.innerHTML = `<img src="http://localhost:8000/static/asset/logo.png?v=${Date.now()}" alt="Chatbot Logo" class="toggle-logo" onerror="this.src='http://localhost:8000/static/asset/fallback.png'; this.onerror=null;">`;
